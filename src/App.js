        ...
        {this.state.showSearchPage ? (
          ...
          <div className="list-books">
            ...
            <div className="list-books-content">
              <div>
                <BookShelf title="Currently Reading" books={this.booksReading}/>
                <BookShelf title="Want to read" books={this.booksWantRead}/>
                <BookShelf title="Read" books={this.booksRead}/>
              </div>
            </div>
